...
class ExpenseCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_category" do
    assert_difference('ExpenseCategory.count') do
      post expense_categories_url, params: { expense_category: { description: @expense_category.description, name: @expense_category.name } }
    end
  ...
  test "should update expense_category" do
    patch expense_category_url(@expense_category), params: { expense_category: { description: @expense_category.description, name: @expense_category.name } }
