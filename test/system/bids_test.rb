...
class BidsTest < ApplicationSystemTestCase
  ...
  test "creating a Bid" do
    ...
    fill_in "Bid date", with: @bid.bid_date
    fill_in "Bid status", with: @bid.bid_status_id
    fill_in "Company", with: @bid.company_id
    fill_in "Description", with: @bid.description
    fill_in "Project site", with: @bid.project_site_id
    fill_in "Sku", with: @bid.sku_id
    click_on "Create Bid"
